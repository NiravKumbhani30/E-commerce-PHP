...
$detail_query = mysqli_query($conn, "INSERT INTO `orders` (`id`, `name`, `number`, `email`, `method`, `flat`, `street`, `city`, `state`, `country`, `pin_code`, `total_products`, `total_price`) VALUES (NULL,'$name','$number','$email','$method','$flat','$street','$city','$state','$country','$pin_code','$total_product','$price_total')") or die('query failed');
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="House no" name="flat" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="pincode" name="pin_code" required>
         </div>
      </div>
